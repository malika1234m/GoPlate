...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "100 dish videos + 100 photoreal 3D models",
...
const comparison: { label: string; basic: string | boolean; starter: string | boolean; pro: string | boolean }[] = [
  ...
  { label: "Auto-edited dish videos", basic: "2", starter: "Up to 10", pro: "Up to 100" },
  { label: "Photoreal 3D dish models", basic: "2", starter: "Up to 10", pro: "Up to 100" },
